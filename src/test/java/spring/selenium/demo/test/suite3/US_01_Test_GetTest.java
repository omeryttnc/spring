...
public class US_01_Test_GetTest {
    ...
    public void getResponse(String endPoint){
        response = given().accept(ContentType.JSON).auth().oauth2(token).when().get(endPoint);
    }
...
//    }
    ...
    public void tc0110(){
        ...
        //Assert.assertEquals(stringDataList.size(), stringDataSet.size());
        int sameData =0;
    ...
    public void tc0117(){
        ...
        //Assert.assertFalse(controlCode>0);
    }
    //@Test
    public void tc0118(){
        int year = 2020;
